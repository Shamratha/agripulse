...
def classify_crops(features, scene):
    ...
    metrics = {
        ...
        "per_class_recall": dict(zip(all_labels, recall.round(3).tolist())),
        "per_class_precision": dict(zip(all_labels, precision.round(3).tolist())),
        "per_class_f1": dict(zip(all_labels, f1.round(3).tolist())),
